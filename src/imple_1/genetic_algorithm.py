...
class Genetic_algorithm(object):
    ...
    #     for i in range(len(self.agents)):
    #         agent = self.agents[i]
    #         fit = agent.fitness(self.student_id)
    #         isfind = isfind or (fit == 1)
    #         fitness[i]= fit
    ...
    def cross_over(self, a1: a.Agent, a2: a.Agent):
        ...
        Args:
            ...
            a2 ([type]): agent 2
        """
        cutpos = random.randint(1, self.length_mdp - 1) * 6
    ...
    def new_generation(self):
        ...
        proba = self.ranking_lineaire(self.fitness_v)  # classement des agents
    ...
    def resolution(self) -> str:
        ...
        last = scores.pop()
        plt.savefig(f"../img/impl1_{self.gen}_{last}.png")
